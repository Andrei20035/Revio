...
**Developer and data controller:** Andrei R.  
**Contact:** threvioapp@gmail.com

Revio is a car-spotting community where people create profiles, share car photos and posts, discover posts, and interact through comments and likes. This Policy explains how Andrei R., the developer of Revio ("Revio", "we", "us", or "our"), collects, uses, shares, stores, and protects personal data in the Revio Android app, its backend, and the related waitlist and support services (together, the "Services").

## 1. Eligibility

Revio is intended for people aged 13 or older. We collect the date of birth entered during profile setup, but it is not displayed publicly. If you believe a child under 13 has provided personal data, contact us so we can investigate and delete it where appropriate.
...
Location is optional and requested only when you create a post. If permitted, we may collect and store the precise latitude and longitude attached to that post and derive its town and country. Revio does not collect location in the background.

Uploaded photos are re-encoded before upload, so EXIF metadata such as GPS tags is not copied to the stored image.
...
- operate profiles, posts, comments, likes, scores, streaks, challenges, rankings, and other social features;
- upload, store, and display images;
- provide optional post location;
- send in-app activity updates;
- handle feedback and support requests;
- investigate abuse and enforce our rules;
...
- **Hetzner Online GmbH** for backend and database hosting;
- **Google** for Google Sign-In, Firebase Analytics, and Firebase Crashlytics; and
- **Supabase** for waitlist data.

These providers process data only to supply their services to Revio and under their applicable terms. We may also disclose data when required by law, to protect users or the Services, or as part of a business transfer subject to appropriate safeguards.

We do not sell personal data or share it for behavioural advertising.

## 5. International processing

Our providers may process data in countries other than your own. Where required, we use appropriate contractual or legal safeguards for international transfers.
...
We use measures designed to protect data, including HTTPS for production network traffic, one-way password hashing, protected token storage on Android, access controls, and limited provider access. No system is completely secure, so absolute security cannot be guaranteed.

## 9. Policy changes

We may update this Policy when the Services or legal requirements change. We will update the effective date and provide additional notice in the app when a change is material.

## 10. Contact

Questions, privacy requests, account-deletion requests, and safety concerns can be sent to:
