...
import com.revio.social.data.remote.dto.post.FeedPostDto
import com.revio.social.data.remote.dto.post.FeedResponse
...
interface PostApi {
    ...
    /**
     * Create a post. Multipart: a JSON `metadata` part ([com.revio.social.data.remote.dto.post.CreatePostMetadata])
