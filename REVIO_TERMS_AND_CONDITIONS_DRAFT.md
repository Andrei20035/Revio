...
**Status:** Draft — review with qualified legal counsel before launch.  
**Effective date:** [REQUIRED BEFORE LAUNCH: DD Month YYYY]  
**Owner:** Revio Team  
**Contact:** threvioapp@gmail.com

Revio is a community for sharing and discovering real car-spotting photography. By creating an account, uploading content, or using Revio, you agree to these Terms of Use and Community Guidelines (together, the “Terms”). If you do not agree, do not use Revio.
...
## 4. Number plates and people in photographs
...
## 5. Your content and Revio’s licence
...
1. **Removal with reason.** We remove the non-compliant content and explain why it was removed.
2. **Formal warning.** If the violation continues or repeats, we notify the user that further violations may lead to suspension or a ban.
3. **Suspension or ban.** If the violation continues after a warning, we may temporarily suspend or permanently terminate the account.
...
## 10. Disclaimers, liability, and governing law
